                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav flex-row flex-wrap ms-lg-auto gap-lg-3">
                            ...
                            <template v-if="username">
                                <li class="nav-item col-6 col-lg-auto"><a class="nav-link" href="#">Hello: {{ username
                                }}</a>
                                </li>
                            ...
                            <li class="nav-item col-6 col-lg-auto">
                                <RouterLink class="nav-link" to="/account/security">
                            ...
                            <li class="nav-item col-6 col-lg-auto">
                                <RouterLink class="nav-link" to="/account/orders">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
